...
/**
 * 재무제표 회계기준 — 두 값뿐이다. 소규모감사기준은 **조서 양식 기준**이라 일반조서 당기 세팅(gwp_year)에 따로 둔다
 * (0152, 사용자 결정 2026-09-26). 0148 에서 여기 셋째 값으로 넣었던 것을 되돌렸다.
 */
export type Basis = 'K-IFRS' | '일반기업회계기준';
export const BASES: Basis[] = ['K-IFRS', '일반기업회계기준'];
