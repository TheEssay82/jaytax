    ...
    <div onClick={onClose} style={{
      ...
      <div className="card" onClick={(e) => e.stopPropagation()} style={{ maxWidth: 940, width: '100%' }}>
        ...
        {rows.length === 0 ? (
          ...
          <>
            <Guide id="invoice-recon" label="세 가지 차이 읽는 법"
              summary={<><b>매출계약은 참고자료</b>입니다 — 청구의 기준은 청구예정입니다. 계약이 맞을 때만 반영하세요.</>}>
              · <b>계약에만</b> ({count('계약에만')}) — 계약엔 있는데 청구예정에 없습니다. 새로 시작한 곳이면 <b>추가</b>합니다.
...
`
  ...
  return (
    <div className="card">
      ...
      <Guide id="invoice-request" label="업무 순서와 표 다루는 법"
        summary={<>
          <b>① 당월 전개 → ② 담당자 확인 → ③ 발행요청 등록 → ④ ERP 대사 → ⑤ 발행완료.</b>
          {' '}금액·담당직원·적요는 ① 표에서 그 자리에서 고칩니다.
        </>}>
        <b>업무 순서</b>
        <br />· ① 김민섭이 <b>당월 전개</b>를 누르면 <b>전월 세금계산서가 그대로 복사</b>되어 청구예정이 됩니다(엑셀에서 전월 열을 복사하던 그 일).
        <br />· ② 담당자 3인이 각자 맡은 곳을 고치고 지우고 더한 뒤 <b>확인</b>을 누릅니다 — 이때 <b>🔍 매출계약 대사</b>로 계약과 맞춰 봅니다.
        <br />· ③ 김민섭이 확인하고 <b>발행요청 등록</b>을 누르면 그 건은 ①에서 ②로 넘어갑니다.
        <br />· ④ ERP 발행내역 대사 → ⑤ <b>발행완료</b> 처리. 승인번호와 발행일을 남깁니다.
        <br /><br /><b>기준과 시점</b>
        <br />· <b>매출계약은 참고자료</b>이고, 청구의 기준은 이 청구예정입니다.
        <br />· 금액은 <b>요청한 시점 기준</b>으로 저장되어, 나중에 계약금액이 바뀌어도 이미 나간 요청은 그대로 남습니다.
        <br />· 연 1회 계약(세무조정 등)은 <b>요청한 달이 곧 그 계약의 청구월</b>이 됩니다 — 계약에 적힌 청구월은
        {' '}지난 실적에서 잡은 예상치라, 실제로 요청하면 그 달로 맞춰집니다.
        <br /><br /><b>표 다루는 법</b>
        <br />· <b>제목행을 누르면 정렬</b>, 그 아래 칸에 값을 넣으면 <b>그 열만 걸러</b> 봅니다.
        <br />· 머리글 오른쪽 끝을 끌면 <b>너비</b>가 바뀌고, 더블클릭하면 내용에 맞춰집니다.
        <br />· <b>⚙️ 열 설정</b>에서 숨김·순서를 정해 저장하면 다음에도 그대로 열립니다.
      </Guide>
